...
class GuidedPolypPVT(nn.Module):
    def __init__(self, channel=32):
        super(GuidedPolypPVT, self).__init__()
    ...
    def forward(self, x, bbox_mask):
        ...
        prediction1_8 = prediction1_8 - self.a * (1 - original_bbox_mask)
        prediction2_8 = prediction2_8 - self.b * (1 - original_bbox_mask)
