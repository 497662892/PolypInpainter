...
if __name__ == '__main__':
    ...
    parser.add_argument('--pth_path', type=str, help="the path for model", default='./model_pth/PolypPVT.pth')
    parser.add_argument('--data_path', type=str, default='/data/diffusers/datasets/polyp/')
    parser.add_argument("--train_dataset_name", type=str, default="polyp")
    parser.add_argument("--save_res", default=False, help="save result", action="store_true")
    parser.add_argument("--save_grid", default=False, help="save grid", action="store_true")
    ...
    for _data_name in dataset_names:
        ...
        # only SUN-SEG has subfolder
        subfolder = "SUN-SEG" in _data_name
        test_loader = test_dataset(image_root, gt_root, subfolder, 352)
        print("Start testing", _data_name)
